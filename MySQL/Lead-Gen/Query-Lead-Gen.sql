...
#4		-- ¿Qué consulta ejecutaría para obtener el número total de sitios creados por mes
...
#6		-- ¿Qué consulta ejecutaría para obtener una lista de nombres de clientes y el número total 
		-- de clientes potenciales que hemos generado para cada uno de nuestros clientes entre el 1 
		-- de enero de 2011 y el 31 de diciembre de 2011?
...
#9		-- Escriba una sola consulta que recupere los ingresos totales recaudados de cada cliente para 
		-- cada mes del año. Pídalo por ID de cliente.
...
#10		-- Escriba una sola consulta que recupere todos los sitios que posee cada cliente. 
		...
		-- Se volverá más claro cuando agregue un nuevo campo llamado 'sitios' 
